...
#include "IBRubyException.h" // force ruby.h then ibase.h
...

{
...

   {
...

      {
         ...
         rb_ibruby_raise(NULL, "Closed connection specified for statement.");
...

   {
      ...
      rb_ibruby_raise(NULL, "Invalid connection specified for statement.");
...

   {
...

      {
         ...
         rb_ibruby_raise(NULL, "Inactive transaction specified for statement.");
...

   {
      ...
      rb_ibruby_raise(NULL, "Invalid transaction specified for statement.");
...

{
...

   {
...

      {
         ...
         rb_ibruby_raise(status, "Error closing statement.");
 ...
 * This function prepares a InterBase SQL statement for execution.
 ...
 * @param  statement    A pointer to a InterBase statement that will be prepared.
...

{
...

   {
      ...
      rb_ibruby_raise(status, "Error allocating a SQL statement.");
   ...
   da->version = SQLDA_CURRENT_VERSION;
...

   {
      ...
      rb_ibruby_raise(status, "Error preparing a SQL statement.");
   ...
   *outputs = da->sqld;
...

   {
      ...
      rb_ibruby_raise(status, "Error determining statement parameters.");
   ...
   *inputs = da->sqld;
...

   {
      ...
      rb_ibruby_raise(status, "Error determining SQL statement type.");
 ...
 * @param  statement   A pointer to the InterBase statement handle to be used in
...

{
...

   {
...

      {
         ...
         rb_ibruby_raise(status, "Error retrieving affected row count.");
