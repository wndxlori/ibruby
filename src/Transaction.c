...

{
...

   {
...

      {
         ...
         rb_ibruby_raise(status, "Error rolling back transaction.");
...

   {
      ...
      rb_ibruby_raise(NULL, "2. Transaction is not active.");
...

{
...

   {
      ...
      rb_ibruby_raise(NULL, "Executed called on inactive transaction.");
...

{
...

   {
      ...
      rb_ibruby_raise(NULL, "No connections specified for transaction.");
...

   {
...

      {
         ...
         rb_ibruby_raise(status, "Error starting transaction.");
