...
//   typedef long long int64_t;  // replaced with ISC_INT64
#endif
...

{
...

   {
      ...
      rb_ibruby_raise(NULL, "Invalid generator name specified.");
...

   {
      ...
      rb_ibruby_raise(NULL, "Invalid connection specified for generator.");
...

{
...

   {
      ...
      rb_ibruby_raise(NULL, "Invalid generator step value.");
...

{
...

   {
      ...
      rb_ibruby_raise(NULL, "Invalid connection specified.");
...

   {
      ...
      rb_ibruby_raise(NULL, "Connection is closed.");
...

      {
...

         {
...

            {
               ...
               rb_ibruby_raise(status, "Error creating generator.");
...

      {
...

         {
...

            {
               ...
               rb_ibruby_raise(status, "Error dropping generator.");
...

{
...

   {
...

      {
         ...
         rb_ibruby_raise(status, "Error obtaining generator value.");
